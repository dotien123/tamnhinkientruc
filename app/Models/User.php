...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'id', 'user_name', 'email', 'phone', 'fullname', 'reg_ip', 'last_login_ip', 'last_login', 'created', 'active', 'status', 'last_active', 'removed'
    ];
    ...
    public static function getThemeCustomizer() {
        return \DB::table('theme_customizer')->where('uid', \Auth::user()->id)->first();
    }
}
