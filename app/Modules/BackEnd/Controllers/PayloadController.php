...
use App\Models\Payload as THIS;


class PayloadController extends BackendController
{
    ...
    public function index(Request $request){
        ...
        if(!empty($cond)) {
            $data = THIS::where($cond)->orderBy('created', 'DESC')->paginate($this->recperpage);
        }else{
            $data = THIS::orderBy('created', 'DESC')->paginate($this->recperpage);
        }
