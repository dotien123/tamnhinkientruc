...
<section id="card-actions">
    ...
    @if (old_blade('editMode'))
        {!! Form::open(['url' => route('admin.' . $key . '.edit.post', old_blade('id')), 'files' => true, 'novalidate'])
        !!}
    @else
        {!! Form::open(['url' => route('admin.' . $key . '.add.post'), 'files' => true, 'novalidate']) !!}
    @endif
    <!-- row -->
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                @include('forms/input-group-text',['placeholder'=>'Name of project...',
                                'field'=>[
                                'label'=>'Name of project', 'key'=>'title', 'class' => 'placement', 'name'=>'title', 'note'
                                => '*', 'classNote' => 'text-danger',
                                'attr' => [
                                ['key' => 'maxlength', 'value' => '255'],
                                ['key' => 'required', 'value' => 'required'],
                                ['key' => 'data-validation-required-message', 'value' => 'Name of project không được để
                                trống.'],
                                ]
                                ],
                                ])
                                    ...
                                    <div class="input-group">
                                        ...
                                        @if(old_blade('editMode'))
                                            <span id="sample-permalink" class="fs-13">
                                                <a href="{{ route('product.detail',['alias' => @$obj->alias,'id' => @$obj->id]) }}" target="_blank"> {{ route('product.detail',['alias' => @$obj->alias,'id' => @$obj->id]) }}</a>
                                            </span>
                                            @endif
                                    </div>
                                    <div class="input-group">
                            ...
                            <div class="col-sm-12">
                                @include('forms/input-group-text',['placeholder'=>'Nhập mã sản phẩm...',
                                'field'=>[
                                'label'=>'Mã sản phẩm', 'key'=>'code', 'class' => 'placement', 'name'=>'code', 'note' =>
                                '*', 'classNote' => 'text-danger',
                                'attr' => [
                                ['key' => 'maxlength', 'value' => '255'],
                                ['key' => 'required', 'value' => 'required'],
                                ['key' => 'data-validation-required-message', 'value' => 'Mã sản phẩm không được để
                                trống.'],
                                ]
                                ],
                                ])
                            ...
                            <div class="col-3">
                                @if ($preview)
                                    <div class="form-group">
                                        ...
                                        <img class="col"
                                            src="{{ isset($obj) ? $obj->getImageUrl('image', 'product', 'original') : '' }}"
                                            alt="{{ @$obj->title }}">
                                    </div>
                                @endif
                            </div>
                                ...
                                @if (@$preview)
                                    <div class="form-group">
                                        ...
                                        <span class="badge badge-primary p-1">
                                            {{ value_show(@$catOpt['_' . @$obj->cate_par]['title'], 'Chưa cập nhật') }}</span>
                                    </div>
                                    <div class="form-group">
                                        <label>Danh mục con: &nbsp</label>
                                        @foreach ($obj->categories as $sub)
                                            <span class="badge badge-primary p-1">
                                                {{ value_show($sub['title'], 'Chưa cập nhật') }}</span>
                                        @endforeach
                                    </div>
                                @endif
                            </div>
                        </div>
                        <!-- tình trạng, khuyến mại-->
                        <div class="row">                           

                            <div class="col-4 col-lg-4">
                                @include('forms/input-group-text',['placeholder'=>'Date...',
                                'field'=>[
                                'label'=>'Date', 'key'=>'date', 'name'=>'date', 'note' => '',
                                'attr' => [
                                ]
                                ],
                                ])
                            ...
                            <div class="col-6  col-lg-4">
                                @include('forms/input-group-text',['placeholder'=>'Client...',
                                'field'=>[
                                'label'=>'Client', 'key'=>'client', 'name'=>'client', 'note' => '',
                                'attr' => [
                                ]
                                ],
                                ])
                            ...
                            <div class="col-4 col-lg-4">
                                @include('forms/input-group-text',['placeholder'=>'Location...',
                                'field'=>[
                                'label'=>'Location', 'key'=>'location', 'name'=>'location', 'note' => '',
                        ...
                        <div class="row">                           
                            ...
                            <div class="col-6  col-lg-6">
                                @include('forms/input-group-text',['placeholder'=>'Status...',
                                'field'=>[
                                'label'=>'Status', 'key'=>'status_text', 'name'=>'status_text', 'note' => '',
                                'attr' => [
                                ]
                                ],
                                ])
                            ...
                            <div class="col-6 col-lg-6">
                                @include('forms/input-group-text',['placeholder'=>'Year project...',
                                'field'=>[
                                'label'=>'Year project', 'key'=>'year', 'name'=>'year', 'note' => '',
                                'attr' => [
                                ]
                                ],
                                ])
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    ...
                                    <ul class="nav nav-tabs nav-justified">
                                        <li class="nav-item">
                                            <a href="#noi-dung-mo-ta" data-toggle="tab" aria-expanded="false"
                                                class="nav-link active">
                                                short description
                                            </a>
                                        </li>
                                        {{-- <li class="nav-item">
                                            <a href="#thanh-phan" data-toggle="tab" aria-expanded="false"
                                                class="nav-link">
                                                Details project
                                            </a>
                                        </li> --}}
                                        {{-- <li class="nav-item">
                                            <a href="#noi-dung-chi-tiet" data-toggle="tab" aria-expanded="false"
                                                class="nav-link">
                                                Liên hệ đặt hàng
                                            </a>
                                        </li> --}}
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content pt-0">
                                            <div class="tab-pane show active" id="noi-dung-mo-ta">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        @include('forms/input-group-textarea',['placeholder'=>'Enter a short description of the component                                                        ','field'=>['label'=>" ",'key'=>'description',
                                                        'class'=>'seo', 'name'=>'description']])
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="tab-pane" id="thanh-phan">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        @include('forms/input-group-textarea',['placeholder'=>'','field'=>['label'=>"
                                                        ",'key'=>'component', 'class'=>'txt_tinymce',
                                                        'name'=>'component']])
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="tab-pane" id="noi-dung-chi-tiet">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        @include('forms/input-group-textarea',['placeholder'=>'','field'=>['label'=>"
                                                        ",'key'=>'content', 'class'=>'txt_tinymce', 'name'=>'content']])
                                                    </div>
                                                </div>
                                            </div> --}}
                                        </div>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="card-body">
                                        <div class="card-box">
                                            <div class="row">
                                                @include('BackEnd::pages.product.include.gallery_product', [
        ...
        <div class="col-12 col-lg-4">
            @if (!$preview)
                <div class="card">
                    ...
                    <ul class="nav nav-tabs nav-justified">
                        <li class="nav-item">
                            <a href="#thong-tin-bo-sung" style="font-size: 12px" data-toggle="tab" aria-expanded="false"
                                class="nav-link active">
                                Avatar
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#danh-muc-tin" style="font-size: 12px" data-toggle="tab" aria-expanded="false"
                                class="nav-link">
                               Category
                            </a>
                        </li>
                        ...
                        {{-- <li class="nav-item">
                            <a href="#thuong-hieu" style="font-size: 12px" data-toggle="tab" aria-expanded="false"
                                class="nav-link">
                                Thương hiệu
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="#dong-xe" style="font-size: 12px" data-toggle="tab" aria-expanded="false"
                                class="nav-link">
                                Chủng Loại
                            </a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="#seo" style="font-size: 12px" data-toggle="tab" aria-expanded="true"
                                class="nav-link">
                                SEO
                            </a>
                        </li> --}}
                    ...
                    <div class="card-body">
                        <div class="tab-content pt-0">
                            <div class="tab-pane show active" id="thong-tin-bo-sung">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            data-img="{{ @$obj->image }}"
                                            data-default-file="{{ isset($obj) ? $obj->getImageUrl('image', 'product', 'original') : '' }}"
                                                name="image" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        'status', 'label' => 'Post now', 'value' => \App\Models\News::STATUS_ACTIVE],
                                        ['id' => 'pending','class' => 'form-check-inline radio-warning', 'key' =>
                                        'status', 'label' => 'Waiting for approval', 'value' =>
                                        \App\Models\News::STATUS_INACTIVE],
                                        ]
                                        ],
                                        'data' => @$obj->status
                                        ])
                            ...
                            {{-- <div class="tab-pane" id="thuong-hieu">
                                {!! $lsBrand !!}
                            </div>

                            <div class="tab-pane" id="dong-xe">
                                {!! $lsVeh !!}
                            </div> --}}
    ...
    <div class="bottom-control">
        <div class="container-fluid control-item">
            ...
            @else
                <a href="{{ route('admin.' . $key) }}" class="btn btn-light btn-xs mr-3">Cancel</a>
            @endif
            ...
            @if (\Lib::can($permission, 'edit'))
                @if ($preview && @$obj['id'])
                    <a href="{{ route('admin.' . $key . '.edit.post', old_blade('id')) }}"
                        class="btn btn-warning waves-effect mr-3"><i class="fe-edit"></i> Edit information
                    </a>
                @else
                    <button type="submit" class="btn btn-teal-800 waves-effect waves-light mr-3"><i class="fe-save"></i>
                       Update</button>
                @endif
            @endif
    ...
    <script>
        $(document).ready(function() {
            ...
            $('input.cker').change(function() {
                if (this.checked) {
                    $(this).parent().append(
                        '<a href="javascript:void(0);" class="font-13 make ml-2">Make primary</a>')
                } else {
                ...
                $('a.make').click(function() {
                    ...
                    $(this).parent().append('<input type="hidden" name="cate_primary" value="' +
                        cate_pri + '" />')
                });
            });
    ...
    <script>
        $(document).ready(function(){
            $('.dropify-clear').click(function(){
                ...
                shop.ajax_popup('product/removeimg1', 'POST', {img:img, id:id}, function(img) {});
            });
        });
    </script>
@endpush
