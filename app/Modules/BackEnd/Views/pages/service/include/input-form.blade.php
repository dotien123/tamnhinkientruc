                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            <div class="row" id="slug-alias">
                                <div class="col-sm-12">
                                    @include('forms/input-group-text',['placeholder'=>'Nhập tiêu đề dịch vụ...',
                                        'field'=>[
                                            'label'=>'Tiêu đề dịch vụ', 'key'=>'title', 'class' => 'placement', 'name'=>'title', 'note' => '*', 'classNote' => 'text-danger',
                                            'attr' => [
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <span id="sample-permalink" class="fs-13">
                                                 <a href="{{ route('service.detail',['alias' => @$obj->alias]) }}" target="_blank"> {{ route('service.detail',['alias' => @$obj->alias]) }}</a>
                                            </span>
                                            @endif
                                        </div>
                                        <div class="input-group">
                                ...
                                <div>
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                        <div class="input-group">
                                            <strong>Hiển thị trong trang dịch vụ &nbsp;</strong>
                                        </div>
                                        <div class="input-group">
                                            <select name="show_on_service_idx" class="form-control">
                                                <option value="0"{{ @$obj->show_on_service_idx === 0 ? ' selected="selected"' : '' }}>Không hiện trang dịch vụ</option>
                                                <option value="1"{{ @$obj->show_on_service_idx == 1 ? ' selected="selected"' : '' }}>Có hiện trang dịch vụ</option>
                                            </select>
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <strong>Liên kết mở rộng &nbsp;</strong> 
                                        </div>
                                        <div class="input-group">
                                            <input value="{{ @$obj->external_link }}" type="text" name="external_link" class="form-control th-service text-blue" id="basic-url" aria-describedby="basic-addon3" placeholder="Liên kết mở rộng">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input value="{{ @$obj->sort_order }}" type="number" name="sort_order" class="form-control th-service text-blue" id="basic-url" aria-describedby="basic-addon3" placeholder="Sắp xếp">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-3">
                                    @if($preview)
                                        <div class="form-group">
                                            ...
                                            <img class="col" src="{{ isset($obj->image) ? $obj->getImageUrl('original') : '' }}" alt="{{ @$obj->title }}">
                                        </div>
                                    @endif
                                </div>
                            </div>
                ...
                @if(!$preview)
                    <div class="card">
                        ...
                        <ul class="nav nav-tabs nav-justified">
                            ...
                            <li class="nav-item">
                                <a href="#danh-muc" data-toggle="tab" aria-expanded="true" class="nav-link">
                                    Danh mục
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="card-body">
                            <div class="tab-content pt-0">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="file"  data-img="{{ @$obj->image }}" class="dropify" data-default-file="{{ isset($obj) ? $obj->getImageUrl('image', 'service', 'original') : '' }}" name="image"  />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="tab-pane" id="danh-muc">
                                    {!! $lsCate !!}
                                </div>
    ...
    <script>
        $(document).ready(function(){
            $('.dropify-clear').click(function(){
                ...
                shop.ajax_popup('service/removeimg', 'POST', {img:img, id:id}, function(img) {});
            });
        })
    </script>
@endpush