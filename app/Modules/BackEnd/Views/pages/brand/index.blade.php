            ...
            @else
                <div class="table-responsive">
                    <div class="d-none" id="popup-action">
                        <div class="show">
                            <a href="javascript:void(0)" class="btn btn-danger mb-3 text-light mt-2 ml-2" onclick="shop.admin.checkAllAction('brand', 'status', -1)" title="Xóa tất cả bản ghi đã chọn">Xóa</a>
                        </div>
                    </div>
                    <table class="table table-centered table-bordered table-hover table table-transparent" id="table-extended-chechbox">
                        ...
                        <tr>
                            ...
                            <th width="130">Tên thương hiệu</th>
                        ...
                        @foreach ($data as $item)
                            @include('BackEnd::pages.brand.include.list-table', [
                            'd' => $item,
                            'sort_col' => 1,
                            'title_col' => 4,
                            'class' => 'alert-success'
