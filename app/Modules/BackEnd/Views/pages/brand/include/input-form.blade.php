                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="row">
                                    <div class="col-sm-12">
                                        @include('forms/input-group-text',['placeholder'=>'Nhập tiêu đề thương hiệu...',
                                        'field'=>[
                                        'label'=>'Tiêu đề thương hiệu', 'key'=>'title', 'class' => 'placement', 'name'=>'title', 'note' => '*', 'classNote' => 'text-danger',
                                        'attr' => [
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" data-img="{{ @$obj->image }}"  class="dropify" data-default-file="{{ isset($obj) ? $obj->getImageUrl('image', 'brand', 'original') : '' }}" name="image"  />
                                </div>
                            </div>
    ...
    <script>
        $(document).ready(function(){
            $('.dropify-clear').click(function(){
                ...
                shop.ajax_popup('brand/removeimg', 'POST', {img:img, id:id}, function(img) {});
            });
        })
    </script>
