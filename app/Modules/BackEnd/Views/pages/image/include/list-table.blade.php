...
<div class="table-responsive">
    <div class="d-none" id="popup-action">
        <div class="show">
            <a href="javascript:void(0)" class="btn btn-danger mb-3 text-light mt-2 ml-2" onclick="shop.admin.checkAllAction('image', 'status', -1)" title="Xóa tất cả bản ghi đã chọn">Xóa</a>
        </div>
    </div>
    <table id="table-extended-chechbox" class="table table-transparent">
        ...
        @foreach($lsObj as $k=>$item)
            <tr>
                ...
                <td align="center">
                    <img width="150px" height="100" src="{{ $item->getImageUrl('medium', 'image') }}" alt="table-user" class="mr-2"/>
                </td>
