            ...
            @else
                <div class="table-responsive">
                    <table class="table table-centered table-bordered table-hover table table-transparent" id="table-extended-chechbox">
                        ...
                        <tr>
                            <th width="55">Sort</th>
                            <th width="95">Cấp 1</th>
                            <th width="95">Cấp 2</th>
                            <th width="95">Cấp 3</th>
                            <th>Tên danh mục</th>
                            <th>Loại danh mục</th>
                            <th width="55" align="center">Trạng thái</th>
                            {{-- <th width="55" align="center" title="Hiển thị ở trang chủ">Trang chủ</th> --}}
                            {{-- <th width="55" align="center" title="Hiển thị ở sidebar">Sidebar</th> --}}
                            {{-- <th width="55" align="center" title="Hiển thị ở menu danh mục">Menu danh mục</th> --}}
                        ...
                        @foreach ($data as $item)
                            ...
                            @foreach ($item['cats'] as $menu)
                                @include('BackEnd::pages.category.include.list-table', [
                                'd' => $menu['data'],
                                'sort_col' => 1,
                                'title_col' => 4,
                                'class' => 'alert-success'
