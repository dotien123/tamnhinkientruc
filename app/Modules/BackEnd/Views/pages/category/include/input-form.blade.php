                        ...
                        <div class="row">
                            <div class="col-lg-9">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        @include('forms/input-group-radio-checked',[
                                        'type'=>'radio', 'field'=>[
                                        'label'=>'Loại danh mục (chọn nếu là danh mục dịch vụ)', 'name' => 'staticpage',
                                        'obj' => [
                                        ['id' => 'publish1','class' => 'form-check-inline radio-success', 'key' =>
                                        'staticpage', 'label' => 'Bài viết đơn', 'value' => \App\Models\News::STATUS_ACTIVE],
                                        ['id' => 'pending1','class' => 'form-check-inline radio-warning', 'key' =>
                                        'staticpage', 'label' => 'Danh sách', 'value' =>
                                    ...
                                    <div class="col-sm-12">
                                        @include('forms/input-group-text',['placeholder'=>'Nhập tiêu đề danh mục...',
                                        'field'=>[
                                        'label'=>'Tiêu đề danh mục', 'key'=>'title', 'class' => 'placement', 'name'=>'title', 'note' => '*', 'classNote' => 'text-danger',
                                        'attr' => [
                                   ...
                                   <div class="col-sm-12">
                                       @include('forms/input-group-text',['placeholder'=>'Nhập năm...',
                                       'field'=>[
                                        'label'=>'Năm', 'key'=>'content', 'class' => 'placement', 'name'=>'content', 'note' => '*', 'classNote' => 'text-danger',
                                      'attr' => [
                                        ['key' => 'maxlength', 'value' => '255'],
                                        ['key' => 'v-model', 'value' => 'input'],
                                        ['key' => 'required', 'value' => 'required'],
                                    ...
                                    <div class="col-sm-12">
                                        @include('forms/input-group-text',['placeholder'=>'Nhập type...',
                                        'field'=>[
                                         'label'=>'Type', 'key'=>'description', 'class' => 'placement', 'name'=>'description', 'note' => '*', 'classNote' => 'text-danger',
                                       'attr' => [
                                         ['key' => 'maxlength', 'value' => '255'],
                                         ['key' => 'v-model', 'value' => 'input'],
                                         ['key' => 'required', 'value' => 'required'],
                                    ...
                                    {{-- <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <span id="sample-permalink" class="fs-13">
                                                @if($obj->type == 1)
                                                    <a href="{{ route( @$obj->pid == 0 ? 'product.storyCate' : 'product.ace',['alias' => @$obj->alias,'id' => $obj->id]) }}" target="_blank">
                                                    {{ route( @$obj->pid == 0 ? 'product.storyCate' : 'product.ace',['alias' => @$obj->alias,'id' => $obj->id]) }}</a>
                                                @elseif($obj->type == 2)
                                                    <a href="{{ route('news.new',['alias' => @$obj->alias,'id' => $obj->id]) }}" target="_blank">
                                                    {{ asset('/') }}{{ @$obj->alias }}-nw{{ @$obj->id }}</a>
                                                @else
                                                    <a href="{{ route('service.cate',['alias' => @$obj->safe_title,'id' => $obj->id]) }}" target="_blank">
                                                    {{ asset('/') }}{{ @$obj->alias }}-sr{{ @$obj->id }}</a>
                                                @endif 
                                            ...
                                            <div class="input-group">
                                                <input value="{{@$obj->alias}}" placeholder="Liên kết tĩnh" type="text" name="alias" class="form-control th-service text-blue" id="basic-url" aria-describedby="basic-addon3">
                                            </div>
                                        </div>
                                    </div> --}}
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select id="type" name="type" data-toggle="select2" class="form-control{{ $errors->has('type') ? ' is-invalid' : '' }}" onchange="shop.getCat(this.value, $('#lang').val())">
                                                <option value="-1">Chưa lựa chọn</option>
                                                @foreach($type as $k => $v)
                                                    <option value="{{ $k }}" @if(old('type',@$obj->type) == $k) selected="selected" @endif>{{ $v }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        'placeholder'=>'Nhập số thứ tự mà bạn muốn','field'=>[
                                        'type' => 'number',
                                        'label'=>'Sắp xếp ','name'=>'sort', 'key' => 'sort', 'class' => 'placement', 'note' => '', 'classNote' => 'text-danger',
                                        'attr' => [
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <input type="file" data-img="{{ @$obj->image }}" class="dropify" data-default-file="{{ isset($obj) ? $obj->getImageUrl('original') : '' }}" name="image"  />
                                </div>
                            </div>
                            {{-- <div class="col-md-12">
    ...
    <script>
        $(document).ready(function(){
            $('.dropify-clear').click(function(){
                ...
                shop.ajax_popup('category/removeimg', 'POST', {img:img, id:id}, function(img) {});
            });
        })
    </script>
@endpush
