<tr>
    <td class="" @if($sort_col > 1) colspan="{{ $sort_col }}" align="right"@endif>
<span class="">
{{str_pad($d->sort, 2, '0', STR_PAD_LEFT)}}
</span>
    </td>
    ...
    {{-- <td style="width:110px" >
        <div class="switchery-demo text-center">
            <input type="checkbox" data-plugin="switchery" data-id="{{ $d->id }}" data-value="{{ $d->is_home }}" data-type="is_home" data-color="#00695c" @if($d->is_home) checked @endif data-size="small"/>
        </div>
    </td>
    <td style="width:110px" >
        <div class="switchery-demo text-center">
            <input type="checkbox" data-plugin="switchery" data-id="{{ $d->id }}" data-value="{{ $d->is_sidebar }}" data-type="is_sidebar" data-color="#00695c" @if($d->is_sidebar) checked @endif data-size="small"/>
        </div>
    </td>
    <td style="width:110px" >
        <div class="switchery-demo text-center">
            <input type="checkbox" data-plugin="switchery" data-id="{{ $d->id }}" data-value="{{ @$d->is_menu_cate }}" data-type="is_menu_cate" data-color="#00695c" @if(@$d->is_menu_cate) checked @endif data-size="small"/>
        </div>
    </td> --}}
