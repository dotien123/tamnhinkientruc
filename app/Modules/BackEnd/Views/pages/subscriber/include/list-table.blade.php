<div class="table-responsive">
    <div class="d-none" id="popup-action">
        <div class="show">
            <a href="javascript:void(0)" class="btn btn-danger mb-3 text-light mt-2 ml-2" onclick="shop.admin.checkAllAction('subscriber', 'status', -1)" title="Xóa tất cả bản ghi đã chọn">Xóa</a>
        </div>
    </div>
