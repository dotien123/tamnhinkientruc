                        ...
                        <div class="card disable-rounded-right mb-0 p-2">
                            <div class="card-header pb-1">
                                <div class="card-title">
                                    <h4 class="text-center mb-2">Xác nhận mật khẩu mới</h4>
                                </div>
                            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <button type="submit" class="btn btn-primary glow position-relative w-100">Xác nhận đổi mật khẩu<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button>
                                    {!! Form::close() !!}
