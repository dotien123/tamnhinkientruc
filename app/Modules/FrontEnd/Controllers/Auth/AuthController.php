...
//            $user_token = CustomerToken::where('customer_id' , '=' , $request->token)->first();
    ...
    public function showPasswordForgot(Request $request){
        $token = CustomerToken::whereToken($request->token)->first();
    ...
    {
        return view('FrontEnd::auth.feedback', [
            'site_title' => 'Đăng nhập'
        ]);
    }
    ...
    public function login(Request $request)
    {
        ...
        $this->validate($request,
            ...
            [
                'userOrEmail.required' => 'Vui lòng điền thông tin tài khoản của bạn để đăng nhập hệ thống',
                'password.required' => 'Chưa nhập Mật khẩu',
            ]
        );
