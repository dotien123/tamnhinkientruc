...
(function ($) {
    ...
    $.fn.imageUploader = function (options) {
        ...
        let defaults = {
            ...
            imagesInputId: 'imgs-'+Math.random(),
        ...
        let createContainer = function () {
            ...
            let $container = $('<div>', {class: 'image-uploader', id: plugin.settings.imagesInputId + '-kayn'}),
                idInput = plugin.settings.imagesInputId
                ...
                $i = $('<i>', {class: 'mdi mdi-cloud-upload', text: ''}).appendTo($textContainer),
        ...
        let createImg = function (src, id) {
            ...
            let $container = $('<div>', {class: 'uploaded-image', id: plugin.settings.imagesInputId + '-kayn'}),
                ...
                $i = $('<i>', {class: 'mdi mdi-close-circle-outline', text: ''}).appendTo($button);
            ...
            $button.on("click", function (e) {
                ...
                if (!$('.image-uploader').find('.uploaded-image').length) {
