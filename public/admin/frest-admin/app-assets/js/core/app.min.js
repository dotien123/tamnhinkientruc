!function (o, r, p) {
    "use strict";
    var c = p("html"), d = p("body"), u = "#FF5B5C";
    if (p(o).scroll(function () {
        ...
        d.hasClass("menu-collapsed") && (a = !0), p("html").data("textdirection"), setTimeout(function () {
            ...
            var a = p(this), n = a.data("icon"), t = p("#main-menu-navigation").data("icon-style");
            a.addLiviconEvo({
                name: n,
                style: t,
                duration: .85,
        ...
        !1 === p.app.nav.initialized && p.app.nav.init({speed: 300}), Unison.on("change", function (e) {
            p.app.menu.change(a)
        }), p('[data-toggle="tooltip"]').tooltip({container: "body"}), p(".tooltip-horizontal-bookmark").tooltip({customClass: "tooltip-horizontal-bookmark"}), 0 < p(".navbar-hide-on-scroll").length && (p(".navbar-hide-on-scroll.fixed-top").headroom({
            offset: 205,
            tolerance: 5,
            ...
            if (d.hasClass("dark-layout")) var a = "#10163a"; else a = "#fff";
            e.block({
        ...
        }, 500), p('.card .heading-elements a[data-action="collapse"]').on("click", function () {
        ...
        var t = p(".chartjs"), s = t.children("canvas").attr("height");
        if (t.css("height", s), d.hasClass("boxed-layout") && d.hasClass("vertical-overlay-menu")) {
            var o = p(".main-menu").width(), i = p(".app-content").position().left - o;
    ...
    p(r).on("click", ".menu-toggle, .modern-nav-toggle", function (e) {
    ...
    }), p(".navigation").find("li").has("ul").addClass("has-sub"), p(".carousel").carousel({interval: 2e3}), p(".nav-link-expand").on("click", function (e) {
        ...
        var a = p(this), n = a.attr("href"), t = p(n).offset().top - 80;
        p("html, body").animate({scrollTop: t}, 0), setTimeout(function () {
            a.parent(".nav-item").siblings(".nav-item").children(".nav-link").removeClass("active"), a.addClass("active")
        }, 100)
    }), i18next.use(o.i18nextXHRBackend).init({
        debug: !1,
        fallbackLng: "en",
        backend: {loadPath: "/admin/frest-admin/app-assets/data/locales/{{lng}}.json"},
        returnObjects: !0
    }, function (e, a) {
        ...
        var a = e.text(), n = e.find(".flag-icon").attr("class");
    ...
    p(".bookmark-wrapper .bookmark-star").on("click", function (e) {
        ...
        var a = p("ul.nav.navbar-nav.bookmark-icons li"), n = "";
        ...
        var e = p(".search-input-close"), a = p(e).parent(".search-input");
        ...
        if (38 !== e.keyCode && 40 !== e.keyCode && 13 !== e.keyCode) {
            ...
            var s = p(this).val().toLowerCase(), o = "", i = !1;
            if (p("ul.search-list li").remove(), p(this).parent().hasClass("bookmark-input") && (i = !0), "" != s) {
                ...
                p.getJSON("app-assets/data/" + h + ".json", function (e) {
                    for (var a = 0; a < e.listItems.length; a++) {
                        ...
                        (0 == e.listItems[a].name.toLowerCase().indexOf(s) && u < 10 || 0 != e.listItems[a].name.toLowerCase().indexOf(s) && -1 < e.listItems[a].name.toLowerCase().indexOf(s) && u < 10) && (l += '<li class="auto-suggestion d-flex align-items-center justify-content-between cursor-pointer ' + (0 === u ? "current_item" : "") + '"><a class="d-flex align-items-center justify-content-between w-100" href=' + e.listItems[a].url + '><div class="d-flex justify-content-start"><span class="mr-75 ' + e.listItems[a].icon + '" data-icon="' + e.listItems[a].icon + '"></span><span>' + e.listItems[a].name + "</span></div>" + d + "</a></li>", u++)
                    }
        ...
        p(e.target).hasClass("bookmark-icon") || (p(".bookmark-input .search-list").hasClass("show") && p(".bookmark-input .search-list").removeClass("show"), p(".bookmark-input").hasClass("show") && p(".bookmark-input").removeClass("show"))
    ...
    }), 20 < p(o).scrollTop() && (p(".navbar-sticky .main-header-navbar").css({
        "background-color": "#ffff",
        "box-shadow": "-8px 12px 18px 0 rgba(25, 42, 70, 0.13)"
    }), p(".navbar-static .main-header-navbar").css({
        "background-color": "transparent",
        "box-shadow": "none"
    })), p(o).scroll(function () {
        20 < p(this).scrollTop() ? p(".navbar-sticky .main-header-navbar").css({
            "background-color": "#ffff",
            "box-shadow": "-8px 12px 18px 0 rgba(25, 42, 70, 0.13)"
        }) : p(".navbar-sticky .main-header-navbar").css({
            "background-color": "#f2f4f4",
            "box-shadow": "none"
        }), p(".navbar-static .main-header-navbar").css({"background-color": "transparent", "box-shadow": "none"})
    }), 20 < p(o).scrollTop() && p(".dark-layout.navbar-sticky .main-header-navbar").css({
        "background-color": "#272e48",
        "box-shadow": "rgba(26, 35, 59, .70) -8px 12px 18px 0px"
    }), p(o).scroll(function () {
        20 < p(this).scrollTop() ? p(".dark-layout.navbar-sticky .main-header-navbar").css({
            "background-color": "#272e48",
            "box-shadow": "rgba(26, 35, 59, .70) -8px 12px 18px 0px"
        }) : p(".dark-layout.navbar-sticky .main-header-navbar").css({
            "background-color": "transparent",
            "box-shadow": "none"
        })
