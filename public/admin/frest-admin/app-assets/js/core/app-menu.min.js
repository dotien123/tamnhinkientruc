!function (s, o, r) {
    "use strict";
    r.app = r.app || {};
    var l = r("body"), d = r(s), m = r('div[data-menu="menu-wrapper"]').html(),
    ...
    r.app.menu = {
        expanded: null, collapsed: null, hidden: null, container: null, horizontalMenu: !1, manualScroller: {
            obj: null, init: function () {
                ...
                this.obj = new PerfectScrollbar(".main-menu-content", {suppressScrollX: !0, wheelPropagation: !1})
            }, update: function () {
                if (this.obj) {
                    if (!0 === r(".main-menu").data("scroll-to-active")) {
                        var e, n, a;
                        if (e = o.querySelector(".main-menu-content li.active"), l.hasClass("menu-collapsed")) r(".main-menu-content li.sidebar-group-active").length && (e = o.querySelector(".main-menu-content li.sidebar-group-active")); else if (n = o.querySelector(".main-menu-content"), e && (a = e.getBoundingClientRect().top + n.scrollTop), a > parseInt(2 * n.clientHeight / 3)) var i = a - n.scrollTop - parseInt(n.clientHeight / 2);
                        setTimeout(function () {
                            r.app.menu.container.stop().animate({scrollTop: i}, 300), r(".main-menu").data("scroll-to-active", "false")
                        }, 300)
                    }
                    this.obj.update()
                }
            ...
            "vertical-menu" !== t && "vertical-menu-modern" !== t || this.toOverlayMenu(a.name, t), l.is(".horizontal-layout") && !l.hasClass(".horizontal-menu-demo") && (this.changeMenu(a.name), r(".menu-toggle").removeClass("is-active")), "horizontal-menu" != t && this.drillDownMenu(a.name), "xl" == a.name && (r('body[data-open="hover"] .dropdown').on("mouseenter", function () {
                ...
                if (e) {
                    var n = r(s).height(), a = r(this).position().top, i = e.offset().left, o = e.width();
            ...
            r('div[data-menu="menu-wrapper"]').html(""), r('div[data-menu="menu-wrapper"]').html(m), r(".menu-livicon").removeLiviconEvo(), r.each(r(".menu-livicon"), function (e) {
                var n = r(this), a = n.data("icon"), i = r("#main-menu-navigation").data("icon-style");
                n.addLiviconEvo({
                    name: a,
                    style: i,
                    duration: .85,
            ...
            var n = r('div[data-menu="menu-wrapper"]'),
                ...
                i = r('li[data-menu="dropdown"]'), o = r('li[data-menu="dropdown-submenu"]');
        ...
        bind_events: function () {
            ...
            r(".navigation-main").on("mouseenter.app.menu", "li", function () {
                ...
                if ("vertical-menu-modern" == l.data("menu") && (r(".main-menu, .navbar-header").addClass("expanded"), l.hasClass("menu-collapsed"))) {
                    ...
                    var e = r(".main-menu li.menu-collapsed-open"), n = e.children("ul");
                ...
                l.hasClass("menu-collapsed") && "vertical-menu-modern" == l.data("menu") && setTimeout(function () {
                    if (0 === r(".main-menu:hover").length && 0 === r(".navbar-header:hover").length && (r(".main-menu, .navbar-header").removeClass("expanded"), l.hasClass("menu-collapsed"))) {
                        var e = r(".main-menu li.open"), n = e.children("ul");
                ...
                var n = r(this);
                if (n.is(".disabled")) e.preventDefault(); else if (n.has("ul")) if (n.is(".open")) n.removeClass("open"), t.collapse(n); else {
                    if (n.addClass("open"), t.expand(n), r(".main-menu").hasClass("menu-collapsible")) return !1;
                    n.siblings(".open").find("li.open").trigger("close.app.menu"), n.siblings(".open").trigger("close.app.menu"), e.stopPropagation()
        ...
        adjustSubmenu: function (e) {
            var n, a, i, o, t, s = e.children("ul:first"), l = s.clone(!0);
            ...
            new PerfectScrollbar(".main-menu-content > ul.menu-content", {wheelPropagation: !1})
        },
