...
function LivIconsEvoDefaults() {
	...
	var defaultOptions = {
		...
		pathToFolder: '/admin/frest-admin/app-assets/fonts/LivIconsEvo/svg/', //the path from root of your site to folder with icons. Also may be as URL, like 'http://yoursite.com/path/to/LivIconsEvo/svg/'
		...
		animated: $('#icon-animation-switch').is(":checked") ? true : false, //if false, an icon is static
